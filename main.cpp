...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"          GREATER NOIDA INSTITUTE OF TECHNOLOGY (GNIOT)"<<endl;
        ...
        cout<<" \t\t                          Education Department, Govt. of UTTAR PRADESH.\n\n";
        for(int i=0;i<118;i++)
        cout<<r7;
        cout<<endl;
        home();
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<66;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"      GREATER NOIDA INSTITUTE OF TECHNOLOGY (GNIOT)   "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" CHARUSAT "<<r6<<"        FACULTY OF ENGINEERING AND TECHNOLOGY,      "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    GREATER NOIDA                  "<<r6<<endl;
        cout<<"\t"<<r6<<"                          Accredited with Grade A+ by NAAC,        "<<r6<<endl;
        cout<<"\t"<<r6<<"                      Education Department, Govt. of UTTAR PRADESH.    "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
        ...
        case 0:
            {
                ...
                system("cls");
                cout<<"\n\n\tPREPARED BY:-"<<endl;
                cout<<"\n\t"<<x<<" RAM NARAYAN JAISWAL          Mob - 9565777968";
                cout<<"\n\t"<<x<<" EMAIL - liveramnarayan9565@gmail.com ";
                getch();
                goto E;
                break;
            }
